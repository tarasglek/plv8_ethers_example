 ...
 */
 export function verifySignature(signature: string, expectedSignerAddress: string, message: string) {
    /*
    ...
    */
    ...
    if (recoveredAddress !== expectedSignerAddress) {
      throw new Error("Invalid signature, does not match expectedSignerAddress")
    }
    return true
  }